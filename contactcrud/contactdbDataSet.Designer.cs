...
namespace contact_crud {
    ...
    public partial class contactdbDataSet : global::System.Data.DataSet {
        ...
        public partial class dataDataTable : global::System.Data.TypedTableBase<dataRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public dataRow AdddataRow(string firstname, string surname, string gender, string phonenumber, string email) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public dataRow FindByuserid(int userid) {
        ...
        public partial class dataRow : global::System.Data.DataRow {
            ...
            public int userid {
                get {
                    return ((int)(this[this.tabledata.useridColumn]));
                }
                set {
                    this[this.tabledata.useridColumn] = value;
                }
            }
            ...
            public string phonenumber {
                get {
                    return ((string)(this[this.tabledata.phonenumberColumn]));
                }
                set {
                    this[this.tabledata.phonenumberColumn] = value;
                }
            }
            ...
            public string email {
                get {
                    return ((string)(this[this.tabledata.emailColumn]));
                }
                set {
                    this[this.tabledata.emailColumn] = value;
                }
            }
        }
...
namespace contact_crud.contactdbDataSetTableAdapters {
    ...
    public partial class dataTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `data` WHERE ((`userid` = @p1) AND (`firstname` = @p2) AND (`surname`" +
                " = @p3) AND (`gender` = @p4) AND (`phonenumber` = @p5) AND (`email` = @p6))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `data` (`firstname`, `surname`, `gender`, `phonenumber`, `email`) VAL" +
                "UES (@p1, @p2, @p3, @p4, @p5)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `data` SET `firstname` = @p1, `surname` = @p2, `gender` = @p3, `phonenumbe" +
                "r` = @p4, `email` = @p5 WHERE ((`userid` = @p6) AND (`firstname` = @p7) AND (`su" +
                "rname` = @p8) AND (`gender` = @p9) AND (`phonenumber` = @p10) AND (`email` = @p1" +
                "1))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::contact_crud.Properties.Settings.Default.ConnSt;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `userid`, `firstname`, `surname`, `gender`, `phonenumber`, `email` FROM `d" +
                "ata`";
        ...
        public virtual int Fill(contactdbDataSet.dataDataTable dataTable) {
        ...
        public virtual contactdbDataSet.dataDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            contactdbDataSet.dataDataTable dataTable = new contactdbDataSet.dataDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(contactdbDataSet.dataDataTable dataTable) {
